...
MoveEnd:
	...
	move BIND,         TWO_TO_FIVE_ATTACKS_EFFECT,             15, NORMAL,    75, 20
	...
	move WRAP,         TWO_TO_FIVE_ATTACKS_EFFECT,             15, NORMAL,    85, 20
	...
	move BLIZZARD,     FREEZE_SIDE_EFFECT,         120, ICE,       90, 10
	move PSYBEAM,      CONFUSION_SIDE_EFFECT,       65, PSYCHIC,  100, 20
	move BUBBLEBEAM,   SPEED_DOWN_SIDE_EFFECT,      65, WATER,    100, 20
	move AURORA_BEAM,  ATTACK_DOWN_SIDE_EFFECT,     65, ICE,      100, 20
	move HYPER_BEAM,   HYPER_BEAM_EFFECT,          150, NORMAL,    90,  5
	move PECK,         NO_ADDITIONAL_EFFECT,        35, FLYING,   100, 35
	move DRILL_PECK,   NO_ADDITIONAL_EFFECT,        70, FLYING,   100, 20
	...
	move FIRE_SPIN,    TWO_TO_FIVE_ATTACKS_EFFECT,  15, FIRE,      100, 15
	...
	move PSYCHIC_M,    NO_ADDITIONAL_EFFECT,    90, PSYCHIC,  100, 10
	move HYPNOSIS,     SLEEP_EFFECT,                 0, PSYCHIC,   80, 20
	...
	move SMOG,         POISON_SIDE_EFFECT2,         50, POISON,    70, 20
	...
	move SKULL_BASH,   NO_ADDITIONAL_EFFECT,              100, ROCK, 90, 15
	...
	move SKY_ATTACK,   HYPER_BEAM_EFFECT,              140, FLYING,    90, 15
	move TRANSFORM,    TRANSFORM_EFFECT,             0, NORMAL,   100, 10
	move BUBBLE,       SPEED_DOWN_SIDE_EFFECT,      40, WATER,    100, 30
	move DIZZY_PUNCH,  CONFUSION_EFFECT,        70, FIGHTING,   100, 10
	move SPORE,        SLEEP_EFFECT,                 0, GRASS,    100, 15
	move FLASH,        ACCURACY_DOWN1_EFFECT,        0, NORMAL,    70, 20
	move PSYWAVE,      SPECIAL_DAMAGE_EFFECT,        1, PSYCHIC,   80, 15
	move SPLASH,       NO_ADDITIONAL_EFFECT,                250, NORMAL,   100, 40
	move ACID_ARMOR,   DEFENSE_UP2_EFFECT,           0, POISON,   100, 40
	move CRABHAMMER,   PAY_DAY_EFFECT,        90, WATER,     85, 10
	...
	move STRUGGLE,     PAY_DAY_EFFECT,               50, NORMAL,   100, 10
