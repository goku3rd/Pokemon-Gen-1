...
; Route 9
	...
	db 22,CATERPIE,WEEDLE,VENONAT,0
LassData:
; Route 3
...
; Route 8
	...
	db 14,PIDGEY,RATTATA,NIDORAN_M,MEOWTH,PIKACHU,0
...
; Route 24/Route 25
	db 24,RATTATA,EKANS,0
; Route 24
	db 28,MANKEY,0
; Route 6
	db 30,SQUIRTLE,0
	db 26,SPEAROW,RATICATE,0
; Unused
	db 18,DIGLETT,DIGLETT,SANDSHREW,0
; Route 9
	db 25,GROWLITHE,CHARMANDER,0
	db 26,RATTATA,DIGLETT,EKANS,SANDSHREW,0
; Route 12
	db 39,NIDORAN_M,NIDORINO,0
JrTrainerFData:
; Cerulean Gym
	db 24,GOLDEEN,0
; Route 6
	db 22,RATTATA,PIKACHU,0
	db 21,PIDGEY,PIDGEY,PIDGEY,0
; Unused
	db 22,BULBASAUR,0
; Route 9
...
; Route 13
	...
	db 35,POLIWAG,POLIWAG,0
	db 30,PIDGEY,MEOWTH,PIDGEY,PIDGEOTTO,0
	db 33,GOLDEEN,POLIWAG,HORSEA,0
; Route 20
	db 34,GOLDEEN,SEAKING,0
; Rock Tunnel 1F
	db 29,BELLSPROUT,CLEFAIRY,0
	db 29,MEOWTH,ODDISH,PIDGEY,0
	db 29,PIDGEY,RATTATA,RATTATA,BELLSPROUT,0
; Route 15
...
; Cinnabar Gym
	db 50,VULPIX,VULPIX,NINETALES,0
	db 55,PONYTA,CHARMANDER,VULPIX,GROWLITHE,0
	db 55,RAPIDASH,0
	db 50,GROWLITHE,VULPIX,0
HikerData:
; Mt. Moon 1F
...
; Cinnabar Gym
	db 55,GROWLITHE,NINETALES,NINETALES,0
	db 55,RAPIDASH,0
	db 50,VULPIX,ARCANINE,0
; Mansion 2F
